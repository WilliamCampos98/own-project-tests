...
<body>
	...
	<a href="${pageContext.request.contextPath}/showAdmins">Listado de
		Admins</a>
	<sf:form action="${pageContext.request.contextPath}/updateDireccion/update"
		method="post" commandName="direccion">
		<table>
			<tr>
				<td>Admin</td>
				<td><select>
						<option value="${direccion.idAd.idAd}">${direccion.idAd.nombre}</option>
						<c:forEach items="${listAdmis}" var="ad">
